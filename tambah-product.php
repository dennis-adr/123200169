...
<body>
    ...
    <div style="color: white; background-color: rgb(44, 44, 150);">
        <center>Tambah Data Inventaris</center>
    </div><br>
    <div>
        <center>
            <form action="" method="POST">
                <table style="border: 0px; text-align:left;">
                    <tr>
                        ...
                        <td><input type="text" name="kode_barang" placeholder="Kode Barang" class="inputt" style="width: 300px;"></td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 20px;">Nama Barang</td>
                        <td><input type="text" name="nama_barang" placeholder="Nama Barang" class="inputt" style="width: 300px;"></td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 20px;">Jumlah</td>
                        <td><input type="number" name="jumlah" placeholder="Jumlah Barang" class="inputt" style="width: 100px;"></td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 20px;">Satuan</td>
                        <td><input type="text" name="satuan" placeholder="Satuan" class="inputt" style="width: 100px;" ></td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 20px;">Tanggal Datang</td>
                        <td><input type="date" name="tgl_datang" placeholder="Tanggal Datang" class="inputt" style="width: 150px;" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="harga" placeholder="Harga Barang Satuan" class="inputt" style="width: 300px;"></td>
                    </tr>
                </table>
                <center>
            ...
            if (isset($_POST['submit'])) {
                ...
                $insert = mysqli_query($connect, "INSERT INTO inventaris (kode_barang,nama_barang,jumlah,satuan,tgl_datang,kategori,status_barang,harga) VALUES ('$kode_barang', '$nama_barang', '$jumlah', '$satuan','$tgl_datang', '$kategori', '$status_barang', '$harga')");
                if ($insert) {
